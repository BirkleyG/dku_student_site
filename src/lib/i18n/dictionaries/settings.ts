...
export const settings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    catMessagesLabel: "Chat & community",
    catMessagesDescription: "Replies, mentions, and activity in Chat and other community messages.",
  ...
  zh: {
    ...
    catMessagesLabel: "聊天与社区",
    catMessagesDescription: "聊天和其他社区消息的回复、提及和动态。",
